        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('restaurateur.restaurant.create')" :active="request()->routeIs('restaurateur.restaurant.create')">
                                {{ __('Créer un Restaurant') }}
                            </x-nav-link>

                            <x-nav-link :href="route('restaurateur.categories.index')" :active="request()->routeIs('restaurateur.categories.*')">
                                {{ __('Catégories') }}
                            </x-nav-link>

                            <x-nav-link :href="route('restaurateur.dishes.index')" :active="request()->routeIs('restaurateur.dishes.*')">
                                {{ __('Plats') }}
                            </x-nav-link>

                            <x-nav-link :href="route('restaurateur.orders.index')" :active="request()->routeIs('restaurateur.orders.*')">
                                {{ __('Commandes') }}
                            </x-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('restaurateur.restaurant.create')" :active="request()->routeIs('restaurateur.restaurant.create')">
                        {{ __('Créer un Restaurant') }}
                    </x-responsive-nav-link>
