...
<div class="container mx-auto px-4 py-8">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Nos restaurants</h2>
        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <form action="{{ route('restaurants.index') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                ...
                <div>
                    ...
                    <a href="{{ route('restaurants.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 active:bg-gray-500 focus:outline-none focus:border-gray-500 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 ml-2">
                        Réinitialiser
                    </a>
                </div>
            </form>
